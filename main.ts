...
async function measuringStick(id: string): Promise<Response> {
  ...
  if (mass_g >= 1000000) answer = `𝐋𝐄𝐀𝐍𝐈𝐍𝐆𝐓𝐎𝐖𝐄𝐑𝐎𝐅𝐏𝐄𝐍𝐎𝐑 RyuChamp ${length.toFixed(1)}" long, ${width.toFixed(0)}" across, ${(mass_g/1000000).toFixed(0)} metric tonnes of cock, at a precarious 3.93° lean! A very girthy attraction...`
